...
use SmsNotifier\Facade\GosmsNotifierFacade;
...
class Plugin
{
    ...
    public function __construct(
        ...
        GosmsNotifierFacade $notifierFacade,
    ...
    public function run(): void
    {
        if (PHP_SAPI === 'fpm-fcgi') {
            $this->logger->info('Gosms SMS over HTTP started');
            $this->processHttpRequest();
        } elseif (PHP_SAPI === 'cli') {
            $this->logger->info('Gosms SMS over CLI started');
            $this->processCli();
        } else {
